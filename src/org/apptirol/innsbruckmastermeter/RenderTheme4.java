 ...
 */
public class RenderTheme4 extends MapViewBaseActivity implements XmlRenderThemeMenuCallback {
	...
	protected XmlRenderTheme getRenderTheme() {
		try {
			...
			Log.e(getString(R.string.app_name), "Render theme failure " + e.toString());
		}
		return null;
	}
	...
	public Set<String> getCategories(XmlRenderThemeStyleMenu menuStyle) {
		...
		if (baseLayer == null) {
			Log.w(getString(R.string.app_name), "Invalid style " + id);
			return null;
		}
